...
# parser.add_argument('--log_files', type=str, default='../data/output1.log')
...
def main():
    ...
    max_episodes = 6000
    log_file = '/home/hhd/PycharmProjects/RL_study_/dqn/maze/data/output/output.log'
    ...
    ax4_legends.append('deep qlearning')
