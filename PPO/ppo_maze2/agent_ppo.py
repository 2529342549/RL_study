...
class PPO_act_FC_Network:
    def __init__(self, state_shape, action_size):
        ...
        fc1 = Dense(256, activation='relu', kernel_initializer=tf.random_normal_initializer(stddev=0.01))(input_x)
        fc2 = Dense(128, activation='relu', kernel_initializer=tf.random_normal_initializer(stddev=0.01))(fc1)
        ...
        self.Model.compile(loss=self.ppo_loss, optimizer=RMSprop(learning_rate))
        # self.Model.summary()
...
class PPO_critic_FC_Network:
    def __init__(self, state_shape, action_size):
        ...
        fc1 = Dense(256, activation='relu', kernel_initializer='he_uniform', input_dim=state_shape)(input_x)
        fc2 = Dense(128, activation='relu', kernel_initializer='he_uniform')(fc1)
        ...
        self.Model.compile(loss=self.cri_loss(old_v), optimizer=RMSprop(learning_rate))
...
class PPO_Agent:
    ...
    # 存储训练数据
    def add_buffer(self, state, action, reward, next_state, act_prob, done, epi):
