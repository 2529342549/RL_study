...
class PPO(object):
    ...
    def save_param(self, e):
        ...
        torch.save(self.actor_net.state_dict(), "/home/hhd/PycharmProjects/RL_study_/PPO/maze2/data/output/" + "actor.pkl")
        torch.save(self.critic_net.state_dict(), "/home/hhd/PycharmProjects/RL_study_/PPO/maze2/data/output/" + "criter.pkl")
